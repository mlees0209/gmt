...
+---------------+-------+--------------------------------------------------------------------------------------------------------+
| **HSV2XYZ**   | 3 3   | Convert *h,s,v* triplets to *x,y,z* triplets, with *h* = A (0-360), *s* = B and *v* = C (0-1)                    |
+---------------+-------+---------------------------------------------------------------------------------------------+
...
+---------------+-------+--------------------------------------------------------------------------------------------------------+
| **RGB2XYZ**   | 3 3   | Convert *r,g,b* triplets to *x,y,z* triplets, with *r* = A, *g* = B, and *b* = C (in 0-255 range)      |
+---------------+-------+--------------------------------------------------------------------------------------------------------+
